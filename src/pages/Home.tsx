...
const QuickLink = ({ to, icon, label, color, glow }: any) => (
  <Link to={to} className="group relative p-0.5 rounded-xl bg-gradient-to-br from-white/10 to-transparent hover:from-white/20 transition-all duration-300 hover:-translate-y-2">
