...
export const Hobbies = () => {
  ...
  return (
    <>
      <SEO 
        title="Hobbies" 
        description="What AgungDev does when not coding: Music, Gaming, and Sports."
      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
          {list.map((h, i) => (
            <div key={i} className={`group relative bg-black/40 border border-white/10 p-8 rounded-3xl overflow-hidden hover:-translate-y-2 transition-all duration-500 hover:shadow-2xl ${h.glow}`}>
              ...
              <div className="relative z-10 flex items-start gap-6">
                  <div className={`p-4 rounded-2xl bg-gradient-to-br ${h.c} text-white shadow-lg`}>
                      <FontAwesomeIcon icon={h.i} className="text-2xl" />
                  </div>
                  <div>
                      <h3 className="text-2xl font-bold text-white mb-2">{h.t}</h3>
