...
export const Testimonials = () => {
  ...
  return (
    <>
      <SEO 
        title="Testimonials" 
        description="Client stories and feedback about AgungDev's work."
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        {loading ? (
          <div className="flex justify-center items-center h-64">
             <FontAwesomeIcon icon={faCircleNotch} className="text-4xl text-cyan-500 animate-spin" />
          </div>
        ) : (
            ...
            {testimonials.map((item, index) => (
              ...
              >
                ...
                <div className="absolute top-6 right-8 text-slate-800 group-hover:text-cyan-500/20 transition-colors duration-500">
                  <FontAwesomeIcon icon={faQuoteRight} className="text-6xl transform rotate-12" />
                </div>
                ...
                <p className="text-slate-300 leading-relaxed mb-8 relative z-10 flex-grow font-light italic">
                  "{item.comment}"
                </p>
